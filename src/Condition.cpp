...
Condition Condition::Impossible("0", 1);
...
Condition::Condition(const std::string &column, const std::string &value,
                     Comparator comp) :
    column(column),
    value(quote(value)), comparatorString(getString(comp)) {}

Condition::Condition(const std::string &column, long long value,
                     Comparator comp) :
    column(column),
    value(std::to_string(value)), comparatorString(getString(comp)) {}
